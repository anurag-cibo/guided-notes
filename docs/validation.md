...
Review-Nachtrag: Screenreader-Prozentwert verwendet dieselbe deutsche Formatierung wie der sichtbare Wert. Der Entfernungstest bestätigt zusätzlich, dass ein anderes aktives Todo in beiden Ansichten erhalten bleibt. Beide betroffenen Testdateien (6 Tests) erneut erfolgreich. Das Startlogo wurde unabhängig mit 9/10 bewertet; Screenshot belegt den hellen Android-Start.
