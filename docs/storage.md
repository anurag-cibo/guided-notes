...
Migration: vorhandene Zwischenziele erhalten Start 0, Ziel 100, Einheit %, current_value=progress und leeres Warum. Frühere Beiträge übernehmen value_amount=amount. Bestehende Inhalte werden weder als Motivation umgedeutet noch umgerechnet. Nutzerkorrektur: Zwischenziele haben kein Warum-Feld in der Oberfläche und verlangen keine Begründung. Die bereits eingeführte motivation-Spalte und das Backupfeld bleiben ausschließlich für den verlustfreien Erhalt schon gespeicherter Daten bestehen. Beim Erstellen großer Ziele wird ein nichtleeres, getrimmtes Warum sowohl im Formular als auch im Repository verlangt; bestehende Ziele und alte Backups ohne Warum bleiben nutzbar.
